        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style2">
                    ...
                    <br />
                    <br />
&nbsp;<asp:TextBox ID="TextBoxDateStart" runat="server" OnTextChanged="TextBoxDate_TextChanged" Width="71px" ReadOnly="True"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBoxDateEnd" runat="server" ReadOnly="True" Width="71px"></asp:TextBox>
                    <br />
                    <br />
                    <br />
                    <asp:Button ID="SelectButton" runat="server" Text="Отобразить измерения" Width="154px" OnClick="SelectButton_Click" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
